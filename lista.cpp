...
void rellenar() {
    ...
    FILE *arch2 = fopen(nombre_archivo,"a+");  //creacion de archivo en modo en que  permite leer y agregar información en un archivo que existe. Si no existe se crea.
